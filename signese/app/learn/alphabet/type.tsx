...
export default function AlphabetTypeScreen() {
  ...
  const handleCheckAnswer = () => {
    ...
    const correctAnswer = currentItem.letter.trim().toUpperCase();

    if (!userAnswer) {
      Alert.alert("Missing answer", "Please type your answer first.");
      return;
    }
  ...
  return (
    <ScreenContainer backgroundColor="#EEF3F1">
      ...
      >
        ...
        <TextInput
          value={inputValue}
          onChangeText={(text) => setInputValue(text.replace(/[^a-zA-Z]/g, "").toUpperCase())}
