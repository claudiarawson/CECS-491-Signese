  ...
  signs: [
    {
      ...
      gif: require("../../../data/asl/Number 1.gif"),
      lessonType: "numbers",
      order: 1,
    ...
    },
    {
      ...
      gif: require("../../../data/asl/number03.jpg"),
      lessonType: "numbers",
      order: 3,
      prompt: "What number is this sign?",
      distractors: ["2", "4", "5"],
    },
    {
      ...
      gif: require("../../../data/asl/number04.jpg"),
      lessonType: "numbers",
      order: 4,
      prompt: "What number is this sign?",
      distractors: ["3", "5", "6"],
    },
    {
      ...
      gif: require("../../../data/asl/number05.jpg"),
      lessonType: "numbers",
      order: 5,
      prompt: "What number is this sign?",
      distractors: ["4", "6", "7"],
    },
    {
      ...
      gif: require("../../../data/asl/number06.jpg"),
      lessonType: "numbers",
      order: 6,
      prompt: "What number is this sign?",
      distractors: ["5", "7", "8"],
    },
    {
      ...
      gif: require("../../../data/asl/number07.jpg"),
      lessonType: "numbers",
      order: 7,
      prompt: "What number is this sign?",
      distractors: ["6", "8", "9"],
    },
    {
      ...
      gif: require("../../../data/asl/number08.jpg"),
      lessonType: "numbers",
      order: 8,
      prompt: "What number is this sign?",
      distractors: ["7", "9", "10"],
    },
    {
      ...
      gif: require("../../../data/asl/number09.jpg"),
      lessonType: "numbers",
      order: 9,
      prompt: "What number is this sign?",
      distractors: ["8", "10", "1"],
