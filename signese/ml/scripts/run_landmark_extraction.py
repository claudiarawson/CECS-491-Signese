"""
run_landmark_extraction.py
--------------------------
Run landmark extraction for the first Signese baseline using MediaPipe Holistic.
...
Outputs:
  - data/processed/landmarks/features/<split>/<LABEL>/<sample_id>.npy
  - data/processed/landmarks/extraction_report.json
...
REPORT_OUT = LANDMARKS_DIR / "extraction_report.json"
...
def build_holistic_for_job(example_job: dict[str, Any]) -> Any:
    ...
    # TODO(extractor): Add alternative backends such as MediaPipe Tasks or OpenPose.
    # TODO(face): Support optional face landmarks later when the first baseline is stable.
...
def main() -> None:
    ...
    report: dict[str, Any] = {
        ...
        "failed_samples": [],
        # TODO(performance): Add multi-worker extraction once single-process output is validated.
        # TODO(normalization): Consider richer sequence-level normalization and masking metadata.
    }
    ...
    print("[ok] Extraction report -> data/processed/landmarks/extraction_report.json")
    print()
